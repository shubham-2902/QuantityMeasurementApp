...
public class QuantityMeasurementAppTest {
	...
	void testPackageStructure_AllLayersPresent() {
	    assertTrue(new File("src/main/java/com/apps/quantitymeasurement/service").exists());
	    assertTrue(new File("src/main/java/com/apps/quantitymeasurement/repository").exists());
	}
